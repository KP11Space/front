...
function getTasks(){
    fetch(mockapiURL, {
        ...
        tasks.forEach(task => {
          ...
          li.innerHTML = `<li class="flex justify-between items-center my-5 px-5 py-3 w-full text-fuchsia-950 rounded-lg" style="box-shadow: inset 4px 4px 13px #C5CAE9; font-family: 'ADLaM Display'; font-weight: 900;">${taskName}
                    <span>TASK NAME</span>
